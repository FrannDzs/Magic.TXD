...
*  FILE:        NativeExecutive/CExecutiveManager.thread.compat.glib.ver2_32.cpp
*  PURPOSE:     Linux GCC libc compatibility layer for threads (GLIBC 2.32)
*
...
const _libc_pthread_functions_2_32 _libc_pthread_functions_2_32_data =
{
